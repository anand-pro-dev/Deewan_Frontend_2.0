...
import { getDPCCAllDevicesWtithOther } from "../../apis/apiConnectSite";
...
const DpccrPlateFormDevices: React.FC = () => {
  ...
  const fetchDevices = async () => {
    try {
      const res = await getDPCCAllDevicesWtithOther();
          ...
          >
            ...
            <div>
              <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-400 bg-clip-text text-transparent">
                Platform Connections With DPCC
              </h1>
...
export default DpccrPlateFormDevices;