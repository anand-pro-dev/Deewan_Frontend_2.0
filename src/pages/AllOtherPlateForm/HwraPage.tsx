...
import { getHWRAAllDevicesWtithOther } from "../../apis/apiConnectSite";
...
const HwraPlateFormDevices: React.FC = () => {
  ...
  const fetchDevices = async () => {
    try {
      const res = await getHWRAAllDevicesWtithOther();
...
export default HwraPlateFormDevices;